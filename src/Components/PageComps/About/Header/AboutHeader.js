        ...
        <>
            ...
            <div className={`${styles.AboutChildContainer} ${styles.AboutHeaderContainer}`}>
                <div className={styles.AboutHeader}>
                    ...
                    <Fade up delay={900}>
                        <div className={styles.text}>Over the past 2 years I have been building applications for many clients to help them connect with their targeted audience. I usually work on a small team to help deliver the application to the client but sometimes I do work solo. In my spare time I enjoy gaming, exercising, and skating.</div>
                    </Fade>
                </div>
            </div>
        </>
